class Role:
    ...
    USER = {
        ...
        "description": "Can add new listings to system."
                       ...
                       "Can view accounts they created and those assigned to them by Admin Users and Manager Users.",
    }
    ...
    SUPER_ADMIN = {
        ...
        "description": "Super Administrator of Application Ecosystem."
                       ...
                       "Can add new clients to the system – all user accounts need to be assigned to a Brand Signals client.",
    }
